...
```
DATABASE_URL=postgresql+asyncpg://forensic_ai:<PASSWORD>@<DB_SERVER_IP>:5432/forensic_ai
```
...
브라우저에서 접속: **http://<DB_SERVER_IP>:5050**
...
async def check():
    conn = await asyncpg.connect(
        "postgresql://forensic_ai:<PASSWORD>@<DB_SERVER_IP>:5432/forensic_ai"
    )
